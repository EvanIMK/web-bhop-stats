				...
				<tbody class="table-tr">
					<?php foreach ($lastrecords as $lastrecordsItem):?>
					    <tr data-bs-toggle="tooltip" data-bs-placement="top" data-bs-html="true" title="<?php echo $sistem->corectDate($lastrecordsItem['date'])['title'] ;?>">
					    	<td><a class="table-a" href="/stats/user/<?php echo $lastrecordsItem['auth'];?>"><?php echo $sistem->userName($lastrecordsItem['auth']);?></a></td>
					        <td><a class="table-a" href="/stats/maps/<?php echo $lastrecordsItem['map'];?>"><?php echo $lastrecordsItem['map'];?></a></td>
